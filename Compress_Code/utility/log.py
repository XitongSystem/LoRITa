...
class Log:
    ...
    def flush(self) -> None:
        if self.is_train:
            ...
            self.string = f"\r┃{self.epoch:12d}  ┃{loss:12.4f}  │{100*accuracy:10.2f} %  ┃{self.learning_rate:12.3e}  │{self._time():>12}  ┃"
            ...
            with open(self.folder+'/'+self.file_name+'.txt', 'a', encoding="utf-8") as f:
                f.write(self.string)
                #f.write('\n')
    ...
    def _print_header(self) -> None:
        ...
        print(f"┃              ┃              ╷              ┃              ╷              ┃              ╷              ┃")
        print(f"┃       epoch  ┃        loss  │    accuracy  ┃     K        │     elapsed  ┃        loss  │    accuracy  ┃")
        print(f"┠──────────────╂──────────────┼──────────────╂──────────────┼──────────────╂──────────────┼──────────────┨")
